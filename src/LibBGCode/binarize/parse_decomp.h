...
typedef struct {
  ...
  void (*const integer_value)(void *self, const char *name, long value);
  void (*const floating_point_value)(void *self, const char *name, double value);
  ...
  void (*const begin_floating_point_array)(void *self, const char *name);
...
BGCODE_CORE_EXPORT bgcode_result_t bgcode_parse_block_decompressed(
    ...
    bgcode_handler_ref_t block_handler, unsigned char *workbuffer,
    size_t workbuf_len);
